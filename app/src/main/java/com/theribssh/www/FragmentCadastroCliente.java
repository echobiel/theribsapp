...
public class FragmentCadastroCliente extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter bandeira = ArrayAdapter.createFromResource(((MainActivity)getActivity()), R.array.bandeiras_cartao, android.R.layout.simple_spinner_item);
        spinner_bandeira_cartao.setAdapter(bandeira);
